    ...
    <div className="bg-[#f9f6f2]">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-medium text-gray-900">Our Newest</h2>
            <p className="text-2xl italic text-[#c9a96e] font-normal">
              Articles
            </p>
          </div>
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[10px] font-medium text-[#c9a96e] tracking-widest">
                    {article.category}
                  </span>
      ...
      <section className="text-center py-12 px-6">
        ...
        <div className="flex items-center justify-center gap-3 max-w-md mx-auto">
          <input
            ...
            className="flex-1 text-sm border border-gray-200 rounded-full px-5 py-2.5 bg-white focus:outline-none focus:border-[#c9a96e]"
          />
          <button className="bg-[#c9a96e] text-white text-sm rounded-full px-6 py-2.5 hover:bg-[#b8945a] transition-colors">
            Subscribe
          </button>
        </div>
      </section>
      ...
      {/* ── Footer ── */}
      <footer className="bg-[#1a1a1a] text-white px-6 pt-12 pb-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Footer links */}
          <div className="grid grid-cols-4 gap-8 border-t border-gray-700 pt-8 text-sm">
            <div>
              <h4 className="font-medium mb-3 text-gray-300">POPULAR</h4>
              {["New Arrivals", "Best Sellers", "Sale", "Showcase"].map(
                (item) => (
                  <Link
                    key={item}
                    href="#"
                    className="block text-gray-500 hover:text-white mb-2 text-xs"
                  >
                    {item}
                  </Link>
                )
            ...
            <div>
              ...
              {["Clothing", "Accessories", "Footwear", "Lifestyle"].map(
                (item) => (
                  <Link
                    key={item}
                    href="#"
            ...
            <div>
              <h4 className="font-medium mb-3 text-gray-300">SUPPORT</h4>
